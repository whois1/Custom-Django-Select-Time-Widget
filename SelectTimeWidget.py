...
class SelectTimeWidget(Widget):
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=False, include_seconds=False):
        """
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        if self.twelve_hr and hour_val == 0:
            hour_val = 12
        ...
        # round values to nearest step value 
        if self.hour_step: 
            hour_val =  self.hour_step * round(hour_val/self.hour_step)
        ...
        if self.second_step: 
            second_val =  self.second_step * round(second_val/self.second_step)
        ...
        self.attrs['id'] = self.hour_field % id_
